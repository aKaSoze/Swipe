...
public class Displacement extends Vector2D<Displacement> {
    ...
    public Displacement delta(Displacement other) {
        Double magnitudeTrans = evaluateMagnitudeOrderTransformation(other.getMeasureUnit());
        return new Displacement((other.getX() * magnitudeTrans) - getX(), (other.getY() * magnitudeTrans) - getY());
    }
